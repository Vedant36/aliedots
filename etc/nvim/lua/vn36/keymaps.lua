...
-- buffer switching {{{1
map('n', '<m-1>', '<Plug>lightline#bufferline#go(1)')
map('n', '<m-2>', '<Plug>lightline#bufferline#go(2)')
map('n', '<m-3>', '<Plug>lightline#bufferline#go(3)')
map('n', '<m-4>', '<Plug>lightline#bufferline#go(4)')
map('n', '<m-5>', '<Plug>lightline#bufferline#go(5)')
map('n', '<m-6>', '<Plug>lightline#bufferline#go(6)')
map('n', '<m-7>', '<Plug>lightline#bufferline#go(7)')
map('n', '<m-8>', '<Plug>lightline#bufferline#go(8)')
map('n', '<m-9>', '<Plug>lightline#bufferline#go(9)')
map('n', '<m-0>', '<Cmd>bl<cr>')
map('n', 'L', '<Cmd>bn<cr>')
map('n', 'H', '<Cmd>bp<cr>')
-- window management {{{1
...
local function bookmark(arg, _prefix)
  ...
  -- prefix need the forward slash `/` at the end
